...
class Deck {
    ...
    /**
     * Deal Method. Creates a PokerHand, then returns it. This hand will be random
     *
     */

    public PokerHand deal()
    {
        final int numCards = 5;   // can change to make any size hand

        PokerHand p = new PokerHand(numCards);


        shuffle(); // make sure we get a random deck
